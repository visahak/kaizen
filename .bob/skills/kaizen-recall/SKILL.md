...
The script will return a list of guidelines in markdown format. Review these carefully. They represent hard-learned lessons or organizational standards. Incorporate them into your approach to the current task. If no guidelines are found, proceed normally.
